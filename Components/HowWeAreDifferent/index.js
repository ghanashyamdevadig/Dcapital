          ...
          <div className={style.right}>
            <div className={style.rightCntr}>
              ...
              <div className={style.howWeAre1}>
                <h1 style={{margin:"0"}}>How we are different </h1>
                <h1 style={{margin:"0"}}>from others?</h1>
              </div>
              <div className={style.adjust}>
                <div className={style.points}>
                  <div className={style.imageIcon}>
                    <Image
                      src={point1}
                      alt="point1"
                      className={style.imageIconArrow}
                    />
                  </div>
                  <div>
                    ...
                    <p className={style.textsmall}>
                      Those days are now passé when purchasing a home used to be
                      a very arduous task ...
                    </p>
                  </div>
                ...
                <div className={style.points}>
                  ...
                  <div>
                    <h3 className={style.textHeader}>
                      On Behalf on you our DC team will verify the properties
                      and we will give 100% assurance before handover..{" "}
                    </h3>
                    <p className={style.textsmall}>
                      Those days are now passé when purchasing a home used to be
                      a very arduous task ...
