...
import style from "./newHow.module.css";
      ...
      <div className={style.backgroundImg}>
        <div className={style.partition}>
         ...
         <Image
          ...
          <h3 className={style.IllustrationText} style={{marginRight:"4em"}}>
            India's leading Real Estate Advisory
          </h3>
          <p className={style.IllustrationTextSmall} style={{marginRight:"2em"}}>
            You can leave it to us to provide your dream home the perfect
          </p>
          <p className={style.IllustrationTextSmall} style={{marginRight:"13em"}}>
